...
R2, R3, C4, and C5 are all optional and can be used to set the gain and bandwidth of the detector yourself, details on this are in the OPT101 datasheet (https://www.ti.com/lit/ds/symlink/opt101.pdf). If you would like to use the chip with its internal gain of 1M$`\Omega`$  then simply short R3 or C5 and leave the others empty.
